        ...
        <div className="container mx-auto px-6 relative z-10">
            ...
            <div className="max-w-5xl mx-auto text-center mb-32">
                 <Reveal width="100%" direction="down">
                    <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-blue-500/10 border border-blue-500/20 text-blue-400 text-xs font-bold tracking-[0.2em] uppercase mb-10 shadow-sm">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 mb-40 items-center">
                {/* Left: The "Card" - Apple Style */}
                <Reveal width="100%" className="perspective-1000">
                    <SpotlightCard 
                        spotlightColor="rgba(6, 182, 212, 0.2)"
                        className="bg-[#0a0a0a] rounded-[3rem] p-10 md:p-14 shadow-2xl border border-white/10 overflow-hidden relative group min-h-[550px] flex flex-col justify-between transform transition-all duration-700 hover:scale-[1.02]"
                    >
                        {/* Background Effects */}
                        ...
                        <div className="relative z-10">
                            <div className="flex items-center justify-between mb-12">
                                ...
                                <div className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center border border-white/10 group-hover:bg-cyan-500 group-hover:border-cyan-400 transition-all duration-300">
                                   <ArrowRight className="w-5 h-5 text-slate-400 group-hover:text-white transition-colors" />
                                </div>
                            </div>
                            
                            <h3 className="text-4xl md:text-5xl font-bold text-white mb-8 leading-[1.1] font-display">
                            ...
                            <Button onClick={() => window.open('https://fastdataconnect.com/', '_blank')} variant="primary" className="w-full md:w-auto font-bold">
                ...
                <div className="relative h-[600px] flex items-center justify-center hidden lg:flex perspective-1000">
            ...
            <div className="max-w-7xl mx-auto mb-40">
                <Reveal width="100%" className="mb-16 text-center">
                     <h3 className="text-4xl font-bold text-white font-display">Core Services</h3>
                    ...
                    {services.map((service, i) => (
                        <Reveal key={i} delay={i * 0.1} width="100%" className="h-full">
                            <SpotlightCard 
                                ...
                                className="flex flex-col h-full p-8 bg-[#0a0a0a] rounded-[2rem] border border-white/10 shadow-sm hover:shadow-2xl hover:shadow-blue-900/10 transition-all duration-500 group relative overflow-hidden"
                            >
                                <div className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-blue-900/20 to-transparent rounded-bl-full -mr-8 -mt-8 opacity-0 group-hover:opacity-100 transition-opacity duration-500 ease-out" />
                                
                                <div className="w-14 h-14 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center text-slate-400 group-hover:text-white group-hover:bg-blue-600 transition-all duration-300 mb-6 shadow-sm group-hover:shadow-lg relative z-10">
                                    <service.icon className="w-7 h-7" />
                                </div>
                                <h4 className="text-xl font-bold text-white mb-3 group-hover:text-blue-400 transition-colors relative z-10">{service.name}</h4>
                                <p className="text-slate-400 leading-relaxed text-sm font-medium relative z-10">{service.desc}</p>
                            </SpotlightCard>
                        </Reveal>
                    ))}
                </div>
            ...
            <div className="mb-40">
                 <div className="text-center mb-12">
                     <span className="text-sm font-bold text-slate-500 uppercase tracking-[0.2em]">Trusted Partners</span>
                 </div>
                 
                 <div className="relative w-full overflow-hidden py-10 bg-black border-y border-white/10">
                    ...
                    <div className="flex w-max animate-marquee hover:[animation-play-state:paused]">
                        {[...partners, ...partners, ...partners].map((partner, i) => (
                            <div key={i} className="mx-12 flex items-center justify-center opacity-30 hover:opacity-100 transition-opacity duration-300">
            ...
            <div className="max-w-5xl mx-auto mb-40 px-6">
                 <Reveal width="100%">
                     <div className="relative bg-black p-12 md:p-24 rounded-[3rem] border border-white/10 shadow-2xl overflow-hidden text-center group">
                        ...
                        <div className="relative z-10 flex flex-col items-center">
                            ...
                            <motion.div 
                                ...
                                className="inline-flex items-center gap-2 px-5 py-2 rounded-full bg-white/5 border border-white/10 backdrop-blur-md mb-12"
                            >
                                <Zap className="w-3 h-3 text-white fill-white" />
                                <span className="text-xs font-bold text-white uppercase tracking-[0.2em]">The Mission</span>
                            </motion.div>
                            
                            <Quote className="w-10 h-10 text-white/20 mb-10 rotate-180" />
                            ...
                            >
                                <div className="text-3xl text-white font-medium" style={{ fontFamily: 'Satoshi, sans-serif' }}>Mike Agar</div>
                                <div className="w-12 h-px bg-gradient-to-r from-transparent via-white/30 to-transparent" />
                                <div className="text-xs font-bold text-slate-500 uppercase tracking-[0.25em]">Founder & CEO</div>
                            </motion.div>
                        </div>
                     </div>
                 </Reveal>
            ...
            {/* CTA Box */}
             <Reveal width="100%" direction="up">
                 <div className="max-w-6xl mx-auto px-4">
                     <div className="bg-[#0b1221] rounded-[3rem] p-12 md:p-24 text-center shadow-2xl border border-white/5 relative overflow-hidden group">
                         ...
                         <div className="relative z-10">
                            <motion.div 
                                ...
                                className="w-24 h-24 mx-auto bg-blue-600 rounded-3xl flex items-center justify-center text-white mb-10 shadow-lg shadow-blue-500/30"
                            >
                                 <Zap className="w-10 h-10" />
                            </motion.div>
                            
                            <h2 className="text-5xl md:text-7xl font-bold text-white mb-8 font-display tracking-tight">Ready to Transform?</h2>
                            <p className="text-slate-400 text-xl md:text-2xl mb-12 max-w-2xl mx-auto font-light leading-relaxed">
                                Let's discuss your business needs and how we can build your digital backbone together.
                            </p>
                            
                            <div className="flex flex-col sm:flex-row justify-center gap-6">
                                <Button onClick={() => onNavigate?.('consultation')} variant="primary" className="px-10 py-5 text-lg font-bold">
                                    Schedule Consultation
                                </Button>
                                <Button onClick={() => onNavigate?.('services')} variant="outline" className="px-10 py-5 text-lg">
                                    View Services
                                </Button>
                            </div>
                         </div>
